...
public class EmployeeServiceImpl implements IEmployeeService {
    ...
    private static final String LINK_EMPLOYEE_FILE = "src\\a_thi_module_2\\data\\employee_file.csv";
...
//        List<Employee> employeeList = ReadAndWriteFile.readEmployeeFromFile(LINK_EMPLOYEE_FILE);
    ...
    public Employee addInfoEmployee() {
        ...
        String department = EnterPeopleInfo.formatAndEnterPeopleName();
        String jobPosition = EnterPeopleInfo.enterEmployeePosition();
        return new Employee(personalID,name, dateOfBirth,address,
                phoneNumber,salary, department,jobPosition);
    }
