...
import package_quan_ly_ss19.service.ITeacherService;
...
import static package_quan_ly_ss19.service.impl.CheckAndEnter.checkAndEnterDate;
import static package_quan_ly_ss19.utils.read_write.WriteFileUtil.writeTeacherFile;

public class TeacherService implements ITeacherService {
    private static Scanner scanner = new Scanner(System.in);
    private static List<Teacher> teachers = new ArrayList<>();
    private static final String SRC_DATA_TEACHERS =  "src\\package_quan_ly_ss19\\data\\teacher_source.csv";
    private static final String DES_LIST_TEACHERS =  "src\\package_quan_ly_ss19\\data\\teacher_source.csv";
